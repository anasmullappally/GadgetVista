import Joi from "joi";
import { fieldBaseMessages, fieldEmptyMessages, fieldInvalidMessages, fieldMaxMessage, fieldMinMessages, fieldPatternMessages, fieldRequiredMessages } from "../utils/message-store/common-messages.js";
...
export const createProductValidation = Joi.object({
    ...
    shippingCharge: Joi.number().max(100).required().messages({
        ...
        "number.max": fieldMaxMessage["shippingCharge"]
    }),
    releaseDate: Joi.string().pattern(/^\d{4}-\d{2}-\d{2}$/).required().messages({
        "any.required": fieldRequiredMessages["releaseDate"],
        "date.base": fieldBaseMessages["releaseDate"],
